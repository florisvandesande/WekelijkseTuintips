---
category_key: algemeen_onderhoud
category_title: "Algemeen onderhoud"
sort_order: 10
items:
  ...
  - id: algemeen-rustige-winterschoonmaak
    ...
    tags: [opruimen, controle, habitat]
    garden_types: [alle]
    body: |
  ...
  - id: algemeen-zomerse-gezondheidsronde
    ...
    priority: high
    conditions: []
    tags: [controle, plaagpreventie, ziektepreventie]
    garden_types: [alle]
    body: |
  ...
  - id: algemeen-hitteronde
    ...
    repeat_every_years: 1
    priority: high
    conditions: [hitte, langdurige_droogte]
  ...
  - id: algemeen-herfst-opruimkeuze
    ...
    priority: medium
    conditions: [bladval]
    tags: [opruimen, habitat, structuur]
    garden_types: [alle]
    body: |
