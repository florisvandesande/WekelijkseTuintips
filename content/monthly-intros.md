---
monthly_intros:
  1: "Januari vraagt om rustig buitenwerk: snoei gericht en geef de tuin winterrust."
  2: "Februari is voorbereiden: maak bedden klaar en start met de eerste vroege klussen."
  3: "Maart brengt beweging: werk de bodem los en begin met de eerste zaairondes."
  ...
  8: "Augustus is doorwerken met beleid: oogsten, nazaaien en bijsturen waar nodig."
  ...
  11: "November is afronden: laatste onderhoud nu geeft een goede start van de winter."
...
Deze content wordt gebruikt voor de korte tekst direct onder het datumbereik op de weekpagina.

Je kunt de zinnen hierboven aanpassen zonder PHP-code te wijzigen.
